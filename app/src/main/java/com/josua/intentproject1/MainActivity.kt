package com.josua.intentproject1
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btn_pindah_data -> {
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Josua Astra Silitonga")
            ...
            R.id.btn_move_activity_object -> {
                val data = Data(
                    "Josua Astra Silitonga",
                    20,
                    "josuasilitonga26@gmail.com",
                    "Pekanbaru"
                )
